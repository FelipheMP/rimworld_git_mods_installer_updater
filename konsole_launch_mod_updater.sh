...
konsole -e python main.py 0 37 &

# Updating more 37 mods = (0 + 37 = 37)
konsole -e python main.py 37 37 &

# Updating more 36 mods = (37 + 36 = 74)
konsole -e python main.py 74 36 &

# Updating more 36 mods = (74 + 36 = 110)
konsole -e python main.py 110 36 &

# Updating last 37 mods = (110 + 37 = 146)
konsole -e python main.py 146 37 &
