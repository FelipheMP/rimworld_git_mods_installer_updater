...
gnome-terminal -- bash -c "python main.py 0 37; exec bash"

# Updating more 37 mods = (0 + 37 = 37)
gnome-terminal -- bash -c "python main.py 37 37; exec bash"

# Updating more 36 mods = (37 + 36 = 74)
gnome-terminal -- bash -c "python main.py 74 36; exec bash"

# Updating more 36 mods = (74 + 36 = 110)
gnome-terminal -- bash -c "python main.py 110 36; exec bash"

# Updating last 37 mods = (110 + 37 = 146)
gnome-terminal -- bash -c "python main.py 146 37; exec bash"
